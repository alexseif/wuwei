...
class TagTypeController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_tag_type_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    public function edit(Request $request, TagType $tagType, EntityManagerInterface $entityManager): Response
    {
        $form = $this->createForm(TagTypeType::class, $tagType);
        $form->handleRequest($request);
    ...
    public function delete(Request $request, TagType $tagType, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$tagType->getId(), $request->request->get('_token'))) {
