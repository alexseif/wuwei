 ...
 */
final class Version20250207132252 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE payments (id INT AUTO_INCREMENT NOT NULL, proposal_id INT DEFAULT NULL, milestone_id INT DEFAULT NULL, description VARCHAR(255) NOT NULL, due_date DATE NOT NULL, amount NUMERIC(10, 2) NOT NULL, status ENUM(\'Pending\', \'Paid\', \'Overdue\'), INDEX IDX_65D29B32F4792058 (proposal_id), INDEX IDX_65D29B324B3E2EDA (milestone_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE requirements (id INT AUTO_INCREMENT NOT NULL, proposal_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, category VARCHAR(255) NOT NULL, priority ENUM(\'High\', \'Medium\', \'Low\'), INDEX IDX_70BEA1AAF4792058 (proposal_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE transactions (id INT AUTO_INCREMENT NOT NULL, payment_id INT DEFAULT NULL, date DATE NOT NULL, amount NUMERIC(10, 2) NOT NULL, type ENUM(\'Income\', \'Expense\'), notes LONGTEXT DEFAULT NULL, INDEX IDX_EAA81A4C4C3A3BB (payment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
